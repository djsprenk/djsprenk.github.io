...
2. **About** — profile photo, bio sections (background, DJ journey, teaching
   focus)
3. **Services** — 6 services: Live DJ, Custom Sets, J&J DJing, Remote DJ, Set
   Downloads, DJ Classes
4. **Music Policies** — text-heavy policy doc with 6 sections
5. **Courses** — gateway listing page
6. **DJ Cheat Codes** — course detail: curriculum (5 modules), format (2 Zoom
...
10. **Feedback** — form: name (opt), role dropdown (opt), email (opt),
    testimonial, consent checkbox
11. **Media Kit** (`/media-kit`) — short bio, 6 downloadable headshots (image
